...
// Função para ler funcionários
$result = mysqli_query($conn, "SELECT * FROM funcionarios");
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
<body>
    ...
    Funcionários Cadastrados <div class="btn-group mb-3" role="group"><a href="../geren.php" class="btn btn-custom btn-primary">Voltar</a>
    <a href="relatorio.php" class="btn btn-custom btn-secondary">Gerar Relatório</a></div>
        ...
        <table class="table">
            ...
            <tr>
                <td style=" text-align: center;"><?php echo $row['func_id']; ?></td>
                <td><?php echo $row['nome']; ?></td>
                <td><?php echo $row['email']; ?></td>
                <td style=" text-align: center;"><?php echo $row['telefone']; ?></td>
                <td style=" text-align: center;"><?php echo $row['cpf']; ?></td>
                <td style=" text-align: center;"><?php echo $row['horas_trabalhadas']; ?></td>
                <td >
                    <div class="btn-groupp">
                        <a href="edit.php?edit=<?php echo $row['func_id']; ?>" class="btn btn-success btn-sm btn-custom editBtn">Editar</a>
                        <a href="deletar.php?delete=<?php echo $row['func_id']; ?>" class="btn btn-danger btn-sm btn-custom editBtn" onclick="return confirm('Tem certeza que deseja deletar este Funcionário?')">Deletar</a>
                    </div>
                </td>
            </tr>
            <?php } ?>
